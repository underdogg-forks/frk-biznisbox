        ...
        {{-- TODO: Start LoadingScreen Filament equivalent --}}
            ...
            <div class="card">
                <form>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {{-- TODO: Convert NumberInput to Filament equivalent --}}
                    ...
                    <div id="bank_account_details">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {{-- TODO: Start TextInput Filament equivalent --}}{{-- TODO: End TextInput --}}
                            {{-- TODO: Start TextInput Filament equivalent --}}{{-- TODO: End TextInput --}}
                        </div>

                        {{-- TODO: Start TextAreaInput Filament equivalent --}}{{-- TODO: End TextAreaInput --}}
                    </div>
