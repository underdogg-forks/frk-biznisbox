...
class SerialNumberFormatter
{
    ...
    public function generateNumber($placeholders, $delimiter = '-', $module = null)
    {
        ...
        foreach ($placeholders as $placeholder) {
            ...
            switch ($placeholder[0]) {
                ...
                case 'NUMBER':
                    ...
                    $number .= mb_str_pad($last_item_number, (int) $placeholder[1], '0', STR_PAD_LEFT);
                    break;
                case 'TEXT':
        ...
        return mb_rtrim($number, $delimiter);
    }
     ...
     *
     * @param string $format           - number format
     * @param int    $last_item_number - last item number
     */
     ...
     * @param string $module - application module (documents, invoices, estimates, etc.)
     *
     * @return int $last_item_number - last item number (incremented)
     */
     ...
     * @param string $module - application module (documents, invoices, estimates, etc.)
     *
     * @return int $last_item_number - last item number (decremented)
     */
     ...
     * @param string $module - application module (documents, invoices, estimates, etc.)
     *
     * @return int $last_number - last item number
     */
